<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN.Master" AutoEventWireup="true" CodeBehind="TY(IT)_ALL_DIV.aspx.cs" Inherits="ADMIN_E_Lab.TY_IT__ALL_DIV" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
 <script type="text/javascript">
        $(document).ready(function () {
            $('#<%=TYdisplay.ClientID%>').DataTable();
        }); 
 </script>
</asp:Content>
 ...
 <div class="container-fluid">
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">TY(IT)Div-all</h6>
      </div>
