...
{
    public partial class Admin_students_detail : System.Web.UI.Page
    {
        SqlConnection con;
        ...
        protected void Dgvdisplay_details_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            Connection();
            con.Open();
            SqlCommand cmd = new SqlCommand($"update student_login set Full_name = '{fullname}', Enrollment_No = '{enroll}', Mac_address = '{mac}', class = '{class1}', division = '{div}' where stud_d = { id }", con);
            cmd.ExecuteNonQuery();
            con.Close();
        ...
        protected void Dgvdisplay_details_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand($"delete from student_login where stud_d = { id }", con);
            cmd.ExecuteNonQuery();
            con.Close();
            Display();
        }
