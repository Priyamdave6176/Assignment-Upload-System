...
{
    public partial class TY_IT__ALL_DIV : System.Web.UI.Page
    {
        SqlConnection con;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                da.Fill(dt);
                TYdisplay.DataSource = dt;
                TYdisplay.DataBind();
                con.Close();

                TYdisplay.UseAccessibleHeader = true;
                TYdisplay.HeaderRow.TableSection = TableRowSection.TableHeader;
            }
        }
